...
# Partie I :  Collecte automatique des offres d’emploi, Matching Offre => CV – Portal Job Madagascar et Offre emploi 
...
# Partie II : Fonctionnalité : Collectes CV, Matching CV → Offres 
...
1. L’image Docker du frontend (kaloina/front-matching:latest) est automatiquement poussée sur Docker Hub via GitHub Actions.
...
L’image Docker du backend (`kaloina/back-matching:latest`) est poussée sur **Docker Hub** via GitHub Actions.  
